...
function notifHref(n: Notification): string {
  ...
  if (n.type === 'friend_finished_book' && n.actor?.id) return `/friends/${n.actor.id}`
...
export default function NotificationsBell() {
  ...
  function notifMessage(n: Notification): string {
    ...
    if (n.type === 'friend_finished_book') return t('friendFinishedBook', { name, title })
    ...
    if (n.type === 'buy_request') return t('buyRequest', { name, title })
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {open && (
        <div className="fixed inset-x-2 top-14 w-auto sm:absolute sm:inset-x-auto sm:right-0 sm:top-full sm:mt-1.5 sm:w-80 rounded-xl border border-stone-200 bg-white shadow-lg z-30 overflow-hidden">
