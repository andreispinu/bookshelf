...
import { BookOpen, Users, Rss, MessageSquare, ArrowLeftRight, ShoppingCart } from 'lucide-react'
...
export default function MobileBottomNav() {
  ...
  const items = [
    ...
    { href: '/feed',       label: t('feed'),      Icon: Rss,            badge: null as null | keyof NavCounts },
